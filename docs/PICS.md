...
For the **BACnet B-SS (Smart Sensor) Go example** -
...
> `CHANGE ALL OF THIS BEFORE YOU SHIP` block at the top of `main.go`. The
...
| **Product Name** | CAS BACnet Stack Example - B-SS (Go) |
| **Product Model Number** | CAS BACnet Stack Example - B-SS (Go) |
